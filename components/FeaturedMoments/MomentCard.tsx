...
export default function MomentCard({ title, description, image, isActive, index }: MomentCardProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className="mt-4 animate-fade-in" style={{ animationDelay: `${index * 200}ms` }}>
